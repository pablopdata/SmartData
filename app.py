...
def index():
    ...
    <head>
        ...
        <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap     <style>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url_for('info') }}">ℹ Información         </ul>
            </div>
        </nav>
        <div class="container">
...
<nav class="navbar navbar-dark bg-dark">
            <a class="navbar-brand" href="{{ url_for('index') }}">ass="container mt-5">
            <h1>Información Adicional</h1>
            <p>Esta es una pantalla de ejemplo que puedes personalizar con contenido adicional.</p>
        </div>
    </body>
    </html>
    """)
